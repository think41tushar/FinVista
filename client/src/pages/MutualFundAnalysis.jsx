...
const MutualFundAnalysis = () => {
  ...
  return (
    <div className="h-screen flex overflow-hidden p-6 gap-4">
      ...
      {/* Chat Section - Fixed width and height */}
      <div className="w-96 flex-shrink-0 border border-[var(--color-grey-dark)] rounded-xl p-1 bg-[var(--color-bg-secondary)] flex flex-col">
        <ChatInterface />
      </div>
    </div>
  );
