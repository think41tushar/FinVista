    ...
    <div className='flex flex-col items-center h-full w-full'>
        <div className='flex justify-between items-center w-full h-full gap-4'>
            ...
            <div className='w-[320px] text-end px-4'>
                <button className='text-2xl text-white font-bold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed' onClick={handleFiClick} disabled={loading}>{status}</button>
            </div>
        </div>
